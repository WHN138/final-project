...
function toggleSidebar() {
    ...
    // Update localStorage with the current status
    const newStatus = $nav.hasClass('close_icon') ? "closed" : "open";
...
// Check localStorage for initial status
const initialSidebarStatus = localStorage.getItem("sidebarStatus");
if (initialSidebarStatus === "closed") {
